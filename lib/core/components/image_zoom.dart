...
class ImageZoom extends StatefulWidget {
  ImageZoom({
    ...
    required this.child,
    this.colorScrollBars = Colors.transparent,
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      ImageZoom.getNearestPointOnLine(point, quad.point0, quad.point1),
      ImageZoom.getNearestPointOnLine(point, quad.point1, quad.point2),
      ImageZoom.getNearestPointOnLine(point, quad.point2, quad.point3),
      ImageZoom.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override
  State<ImageZoom> createState() => _ZoomState();
}

class _ZoomState extends State<ImageZoom> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ImageZoom oldWidget) {
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return ImageZoom.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside =
        ImageZoom.getNearestPointInside(point, boundary);
